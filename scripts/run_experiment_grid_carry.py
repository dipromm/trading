...
PROFILES: list[str | None] = [
    ...
    "profiles/experiments/exp2_stop_loss_holgado.yaml",
    "profiles/experiments/exp1_exp2_combined.yaml",
    "profiles/experiments/exp3_conspiranoico_soft.yaml",
    "profiles/experiments/exp1_exp3_combined.yaml",
    "profiles/experiments/exp4_cazador_modulador.yaml",
    "profiles/experiments/exp1_exp3_exp4_combined.yaml",
    "profiles/experiments/exp5_mas_exposicion_normal.yaml",
    "profiles/experiments/exp1_exp3_exp5_combined.yaml",
    "profiles/experiments/exp6_juez_passthrough.yaml",
    "profiles/experiments/exp1_exp3_exp6_combined.yaml",
    "profiles/experiments/exp7_rotacion_defensivos.yaml",
    "profiles/experiments/exp1_exp3_exp7_combined.yaml",
    "profiles/experiments/exp8_veto_tuned.yaml",
    "profiles/experiments/exp1_exp3_exp8_combined.yaml",
    "profiles/experiments/exp1_exp3_exp8_p3_combined.yaml",
    "profiles/experiments/exp1_exp3_exp8_exp9_combined.yaml",
    "profiles/experiments/exp1_exp3_exp8_exp10_combined.yaml",
]
