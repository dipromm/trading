...
class Cazador(AgentBase):
    ...
    def precompute_insider_signals(
        ...
        """
        from data.insiders import download_all_insiders
    ...
    def fetch_insider_activity(self, ticker: str) -> pd.DataFrame:
        ...
        from data.insiders import download_insider_ticker, load_cached_insiders
    ...
    def predict(self, data: pd.DataFrame) -> pd.Series:
        ...
        from data.insiders import build_alert_series
